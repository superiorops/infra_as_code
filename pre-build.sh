...
sed -e  "s,#ENVIRONMENT#,$ENV,g" \
    -e  "s,#AGENT_INBOUND_PORTS#,$AGENT_INBOUND_PORTS,g" -e "s,#AGENT_VM_SIZE#,$AGENT_VM_SIZE,g" \
    -e  "s,#WEB_INBOUND_PORTS#,$WEB_INBOUND_PORTS,g" -e  "s,#WEB_VM_SIZE#,$WEB_VM_SIZE,g" \
    -e  "s,#WEB_INBOUND_PORTS#,$WEB_INBOUND_PORTS,g" -e  "s,#WEB_VM_SIZE#,$WEB_VM_SIZE,g" -e  "s,#WEB_NODE_COUNT#, $WEB_NODE_COUNT,g"  \
    -e  "s,#DB_INBOUND_PORTS#,$DB_INBOUND_PORTS,g"   -e  "s,#DB_VM_SIZE#,$DB_VM_SIZE,g" 
